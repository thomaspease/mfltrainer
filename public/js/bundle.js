...
function sentencetableTemplate(locals) {
  ...
  (function (fields, sentences) {
    pug_html = pug_html + "\u003Ctable\u003E"; // iterate sentences
    ...
    (function () {
      ...
      if ('number' == typeof $$obj.length) {
        for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
          var sentence = $$obj[pug_index0];
          pug_html = pug_html + "\u003Ctr\u003E\u003Ctd\u003E\u003Cinput" + (" type=\"checkbox\" checked=\"\"" + pug_attr("data-sentence_id", sentence.data._id, true, false)) + "\u002F\u003E\u003C\u002Ftd\u003E"; // iterate fields
          ...
          (function () {
            ...
            if ('number' == typeof $$obj.length) {
              for (var pug_index1 = 0, $$l = $$obj.length; pug_index1 < $$l; pug_index1++) {
                ...
                pug_html = pug_html + "\u003Ctd\u003E" + pug_escape(null == (pug_interp = sentence.data[field]) ? "" : pug_interp) + "\u003C\u002Ftd\u003E";
              }
            } else {
              var $$l = 0;
  ...
  }).call(this, "fields" in locals_for_with ? locals_for_with.fields : typeof fields !== "undefined" ? fields : undefined, "sentences" in locals_for_with ? locals_for_with.sentences : typeof sentences !== "undefined" ? sentences : undefined);
  ;
  return pug_html;
}
...
class CreateTaskView extends View {
  ...
  updateDisplay(sentences, toSave) {
    ...
    this.elements.table.innerHTML = (0, _sentencetable.sentencetableTemplate)({
      fields,
      sentences
    });
  }
