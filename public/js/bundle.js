...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"exercises.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchUser = exports.fetchWords = void 0;
...
},{"axios":"../../node_modules/axios/index.js"}],"createSentences.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postSentence = void 0;
...
const postSentence = async (sentence, translation, level, vivaRef, tense, grammar) => {
  try {
    const res = await (0, _axios.default)({
      method: 'POST',
      url: '/api/v1/sentences',
    ...
    if (res.data.status === 'success') {
      (0, _alerts.showAlert)('success', 'Sentence created!');
    }
  } catch (err) {
    (0, _alerts.showAlert)('error', err.response.data.message);
  }
...
exports.postSentence = postSentence;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"axiosMethods.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.axiosReq = exports.getWithCollectionAndQueryString = void 0;
...
const getWithCollectionAndQueryString = async (collection, queryString) => {
  try {
    const res = await (0, _axios.default)({
      method: 'GET',
      url: "/api/v1/".concat(collection, "?").concat(queryString)
    });
...
exports.getWithCollectionAndQueryString = getWithCollectionAndQueryString;

const axiosReq = async (collection, data, method) => {
  try {
    const res = await (0, _axios.default)({
      method,
      url: "/api/v1/".concat(collection),
      data
    });
...
var _createSentences = require("./createSentences");

var _axiosMethods = require("./axiosMethods");
...
let user;
let quNum = 0;
let missingWord; //Populate states

(async () => {
  sentences = await (0, _exercises.fetchWords)();
})();

(async () => {
  user = await (0, _exercises.fetchUser)();
})(); // DELEGATION
//Login
...
if (createSentenceForm) {
  createSentenceForm.addEventListener('submit', e => {
    ...
    (0, _createSentences.postSentence)(sentence, translation, level, vivaRef, tense, grammar);
  });
...
if (createTaskForm) {
  createTaskForm.addEventListener('submit', async e => {
    ...
    try {
      ...
      const query = decodeURIComponent(setTaskQuery.toString()); //Get sentences with API

      const filteredSentences = await (0, _axiosMethods.getWithCollectionAndQueryString)('sentences', query); //Create new task for class
      ...
      const newTask = await (0, _axiosMethods.axiosReq)('tasks', body, 'POST'); // Assign task to class or students

      const patchBody = {
        $push: {
          tasks: newTask.data.data.data._id
        }
      };
      (0, _axiosMethods.axiosReq)("classes/".concat(select.value), patchBody, 'PATCH');
    } catch (err) {
...
if (document.querySelector('.triple__radio')) {
  ...
  startBtn.addEventListener('click', e => {
    e.preventDefault();
    displayGappedQu(sentences[quNum].sentence);
    audio.src = "/audio/".concat(sentences[quNum].audio);
    document.querySelector('audio').play();
  });
  answerBtn.addEventListener('click', e => {
    if (document.querySelector('input').value == missingWord) {
      ...
      audio.src = "/audio/".concat(sentences[quNum].audio);
      audio.play();
      (0, _alerts.showAlert)('error', 'Wrong!');
      document.querySelector('input').value = '';
    }
  });
}
...
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./exercises":"exercises.js","./alerts":"alerts.js","./createSentences":"createSentences.js","./axiosMethods":"axiosMethods.js","./updateSettings":"updateSettings.js"}]},{},["index.js"], null)
